...
const [showPassword, setShowPassword] = React.useState(false);
  ...
  const handleMouseDownPassword = (event) => {
    ...
    const { Firstname, Lastname, gender, email , phone,oldpassword, password, confpassword,test} = user;
    const { id } = useParams();
    ...
    const loadUserDetails = async() => {
        ...
        response.data.test=response.data.confpassword;
    ...
    return (
        <Container injectFirst>
            <Typography variant="h4" color='#008000'>Edit Information</Typography>
            <FormControl>
          ...
          <Input onChange={(e) => onValueChange(e)} name='oldpassword' value={oldpassword} id="my-input"
        ...
        {error2 && <Alert severity="error">old password is incorrect</Alert>}
            <FormControl variant="standard">
